          ...
          <div className="py-24 lg:py-32">
            <div className="relative z-10 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 max-w-3xl text-xl text-warm-gray-500">
                Sản phẩm được sản xuất trên dây chuyền công nghệ tiên tiến, các hạt nhựa
                bền và chắc. Kích Thước, Mẫu Mã Đa Dạng. Chất Lượng In Đạt Chuẩn. Đảm Bảo
                Giá Cạnh Tranh! Sản Phẩm Chất Lượng Cao. Hỗ Trợ Tư Vấn Nhanh Chóng. Dịch
                Vụ Khách Hàng Uy Tín.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-teal-50">
                      <EnvelopeIcon
                        ...
                        aria-hidden="true"
                      />
                      <span className="ml-3">vothanduy801@gmail.com</span>
                    </dd>
                  </dl>
